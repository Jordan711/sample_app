...
describe User do
  before { @user = User.new(:name => "Example User", :email => "b@b.net",
  ...
  describe "Invalid email format" do
    it "should be invalid " do
      addresses = %w[user@foo,com user_at_foo.org example.user@foo.
                     foo@bar_baz.com foo@bar+baz.com haha@yeet...com]
  ...
  describe "Same email address but upper case" do
    before do
  ...
  describe "when password is not present" do
    before do
      @user = User.new(:name => "name", :email => "bo@b.net",
  ...
  describe "with a password that was too short" do
  ...
  describe "return value of the authenticate method" do
    ...
    describe "with invalid password" do
      ...
      #Bottom line receives the error when it be
